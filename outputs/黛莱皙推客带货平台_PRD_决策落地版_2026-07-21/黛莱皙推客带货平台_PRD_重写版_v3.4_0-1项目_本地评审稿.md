...
| 客户端 | 用户角色 | 主要任务 | 权限与数据范围 |
| --- | --- | --- | --- |
| 小程序 | 游客 | 浏览公开内容 | 仅公开内容 |
| 小程序 | 已登录未开通用户 | 浏览并在受限操作时开通推广大使 | 本人基础信息 |
| 小程序 | 推广大使 | 推广、自购、查看收益、提现和邀请 | 本人数据及一层直接好友 |
| 运营后台 | 内容运营 | 同步、配置和发布内容 | 内容管理及获授权一级模块 |
| 运营后台 | 推客/订单运营 | 查询推客、资格、订单和归因 | 推客或订单模块 |
| 运营后台 | 财务人员 | 对账、审核提现和配置资金规则 | 财务模块 |
| 运营后台 | 系统管理员 | 配置系统、账号权限和审计 | 获授权一级模块 |
